...
/**
 * The bench log. Entries run newest first and carry the same record a herbarium
 * sheet would: a number, a date, a place. `span` is the entry's width on the
 * twelve-column mosaic — each month's spans sum to whole rows, which is what
 * keeps the page composed instead of ragged.
 */
export const JOURNAL = [
  {
    ...
    span: 7,
    src: atelier01,
    place: "Bancada da cozinha",
    caption: "Domingo de manhã, a bancada toda em vermelho e amarelo. Seis pares a secar e nenhum sítio para pousar o café.",
    likes: 214,
  },
  {
    id: "n10",
    ...
    name: "Estrela Âmbar",
    technique: "Resina âmbar, molde próprio",
    caption: "Quarta tentativa. As três primeiras ficaram com bolhas presas nas pontas.",
    likes: 122,
  },
  {
    id: "n09",
    ...
    note: "Regra da casa, afixada no frigorífico desde o Inverno passado.",
  },
  {
    id: "n08",
    no: 8,
    ...
    log: ["09:12 — inspecção dos moldes", "09:14 — adormeceu", "13:40 — acordou, exigiu almoço"],
    likes: 941,
  },
  {
    id: "n07",
    ...
    span: 8,
    src: atelier03,
    place: "Janela da sala, fim da tarde",
    caption: "Azul sobre azul, e um violeta que sobrou de outra peça. Foi assim que a Lua Cobalto apareceu.",
    likes: 276,
  },
  {
    id: "n06",
    ...
    span: 5,
    src: atelier02,
    place: "Pedra de calçada, pátio",
    caption: "Gipsófila prensada há duas semanas entre as páginas do dicionário. Valeu a espera.",
    likes: 389,
  },
  {
    id: "n05",
    ...
    kind: "recipe",
    span: 7,
    title: "Verdes de Agosto",
    colors: [
      { hex: "#2AA394", name: "Jade, 3 gotas" },
      { hex: "#0E6F63", name: "Jade + preto, 1 ponta" },
      { hex: "#B9CB8A", name: "Musgo, 2 gotas" },
      { hex: "#EAF1D6", name: "Base leitosa" },
    ],
    caption: "A mistura que acabou no Conjunto Gota de Jade. Anotada antes de nos esquecermos outra vez.",
  },
  {
    id: "n04",
    no: 4,
    ...
    name: "Gota de Jade",
    technique: "Três camadas, gipsófila prensada",
    caption: "Primeira camada de verde a curar. Faltam mais duas e quarenta e oito horas.",
    likes: 168,
  },
  {
    id: "n03",
    ...
    note: "Escrito depois de encontrar uma pegada numa peça ainda mole.",
  },
  {
    id: "n02",
    no: 2,
    ...
    span: 8,
    art: { shape: "paw", from: "#F4A83C", to: "#D1462F", accent: "#FFE6C9", hardware: "gold" },
    name: "Pata, tamanho real",
    technique: "Molde tirado de uma pegada em farinha",
    caption: "A pata oficial. Aprovada pelo próprio, que se sentou em cima do molde para confirmar.",
    likes: 502,
  },
  {
    id: "n01",
    ...
    kind: "recipe",
    span: 4,
    title: "Rosa velho, 3.ª tentativa",
    colors: [
      { hex: "#FBD9D0", name: "Base" },
      { hex: "#E8917F", name: "Terra rosa" },
    ],
    caption: "Lixado até perder o brilho. Ficou com um toque de porcelana.",
  },
];
